...
@section('title', 'Approve Loans Informations')

@section('page-title', 'Approve Loans Informations')
            ...
            <table class="arbif-table"
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('viewapproveloansinformations', encrypt($item->id)) }}"
