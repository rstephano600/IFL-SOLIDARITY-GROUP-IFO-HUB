...
@section('title', 'Double Loan Application')

@section('page-title', 'Underwriting & Loan Doubling')
...
<div class="arbif-card mb-4">
    <div class="arbif-card-body d-flex justify-content-between align-items-center">
        <h4 class="mb-0 text-warning fw-bold">
            <i class="fas fa-gavel me-2"></i> Double This Loan
        </h4>
    ...
    <div class="col-lg-4">
        <div class="arbif-card">
            <div class="arbif-card-body">
                ...
                {{-- ======================================================== --}}
                {{-- PATHWAY A: APPROVAL FORM                                 --}}
                {{-- ======================================================== --}}
                <form action="{{ route('approveloansinfo', Crypt::encrypt($data->id)) }}" method="POST">
                    @csrf
                    
                    <h5 class="border-bottom pb-2 fw-bold text-success mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="remarks" name="remarks" rows="3" placeholder="Provide authorization remarks..."></textarea>
                    </div>

                    <div class="d-grid mb-4">
                        <button type="submit" class="btn btn-success btn-lg" onclick="return confirm('Are you sure you want to APPROVE this loan?')">
                            <i class="fas fa-check me-2"></i> Authorize & Approve
                        </button>
                    </div>
                </form>
                ...
                {{-- ======================================================== --}}
                {{-- PATHWAY B: REJECTION FORM                                --}}
                {{-- ======================================================== --}}
                <form action="{{ route('approveloansinfo', Crypt::encrypt($data->id)) }}" method="POST">
                    @csrf

                    <h5 class="border-bottom pb-2 fw-bold text-danger mb-3">
                        <i class="fas fa-ban me-2"></i> Reject Loan Application
                    </h5>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control border-danger" 
                                ...
                                name="RejectReasons" 
                                rows="3" 
                                placeholder="State explicitly why this application was denied..." 
                                required></textarea>
                    </div>

                    <div class="d-grid">
                        <button type="submit" class="btn btn-danger btn-lg" onclick="return confirm('Are you sure you want to REJECT this loan application?')">
