...
@section('title', 'Close Loans Informations')

@section('page-title', 'Close Loans Informations')
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('approveloansinfo', encrypt($item->id)) }}"
                               ...
                               onclick="return confirm('Are you sure you want to CLOSE this Loan Information?');">
