...
class Brand extends Model
{
    ...
    /**
     * Auto-generate BrandRefNo on creation if not provided.
     */
    protected static function booted()
    {
        static::creating(function ($brand) {
            if (empty($brand->BrandRefNo)) {
                $lastId = static::max('id') + 1;
                $brand->BrandRefNo = 'BRD-' . str_pad($lastId, 4, '0', STR_PAD_LEFT);
            }
        });
    }
    ...
    // Uncomment if products belong to brands
